...
export const POSTS_WALLPAPER = new THREE.TextureLoader().load(
  "./textures/posts_wallpaper.png"
);
export const POLLS_WALLPAPER = new THREE.TextureLoader().load(
  "./textures/polls_wallpaper.png"
);
export const MAPS_WALLPAPER = new THREE.TextureLoader().load(
  "./textures/maps_wallpaper.png"
);

// Dark Mode Phone Wallpapers
export const DARK_POSTS_WALLPAPER = new THREE.TextureLoader().load(
  "./textures/dark_posts_wallpaper.png"
);
export const DARK_POLLS_WALLPAPER = new THREE.TextureLoader().load(
  "./textures/dark_polls_wallpaper.png"
);
export const DARK_MAPS_WALLPAPER = new THREE.TextureLoader().load(
  "./textures/dark_maps_wallpaper.png"
);
