...
<section class="section mt-20 sticky top-32">
	...
	{:else if ScrollPercentage > 65}
		...
		<h1 style="right: -{ScrollPercentage - 30}rem;" class="outlined z-0 absolute top-[-20rem] text-9xl pointer-events-none text-black tracking-widest font-sans" out:fade={{ duration: 300 }} in:fade={{ duration: 300 }}>
			MAPS
		</h1>
