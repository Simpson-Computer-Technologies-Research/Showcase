...
<!-- Custom Cursor -->
<div
	class="cursor fixed pointer-events-none border-2 border-white p-[0.6rem] rounded-full mix-blend-difference z-30 ease-linear"
/>
...
<div id="loading-header" class="fade-in">
	...
	<div
		class="mx-[40rem] h-1 flex justify-center items-center bg-gray-200 mt-10 rounded-full"
	/>
</div>
